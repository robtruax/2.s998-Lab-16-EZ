...
BHV_RubberBandTruax::BHV_RubberBandTruax(IvPDomain gdomain) : 
  IvPBehavior(gdomain)
{
...
bool BHV_RubberBandTruax::setParam(string param, string val) 
{
...
void BHV_RubberBandTruax::onSetParamComplete() 
{
...
void BHV_RubberBandTruax::onRunToIdleState()
{
...
void BHV_RubberBandTruax::onIdleState()
{
...
IvPFunction *BHV_RubberBandTruax::onRunState() 
{
  // Set m_osx, m_osy
  if(!updateInfoIn())
    return(0);
...
bool BHV_RubberBandTruax::updateInfoIn()
{
  bool ok1, ok2;
...
bool BHV_RubberBandTruax::updateCenter()
{
  if(!m_center_pending)
    return(true);
...
void BHV_RubberBandTruax::postStationMessage(bool post)
{
...
void BHV_RubberBandTruax::postViewableTrailPoint()
{
...
void BHV_RubberBandTruax::postErasableTrailPoint()
{
  m_trail_point.set_active(false);
  string spec = m_trail_point.get_spec();
  postMessage("VIEW_POINT", spec);
